...
// User Routes
router.route("/").post(registerUser).get(protect, admin, getUsers); // protected route from anuthorized users using protect middleware && non admins using admin middleware
